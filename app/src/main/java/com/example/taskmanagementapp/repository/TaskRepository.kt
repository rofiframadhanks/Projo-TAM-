...
class TaskRepository(private val db: TaskDatabase) {
    ...
    fun getTodoTasks() = db.getTaskDao().getAllTodoTasks()

    fun getProgressTasks() = db.getTaskDao().getAllProgressTasks()

    fun getCompleteTasks() = db.getTaskDao().getAllCompleteTasks()
